...
Original file is located at
    https://colab.research.google.com/drive/1Ne1PaIorcAFF8zzS9fct2-mEM8641dLh
"""
...
dataset = pd.read_csv('/app/product.csv')  # Replace with your dataset
...
# result = get_similar_items(input_text, top_n=3)
# print(result)

# # Save the model as a pickle file
# with open("clothing_model.pkl", "wb") as file:
#     pickle.dump(get_similar_items, file)

import pickle

# Load the model from the pickle file
with open("clothing_model.pkl", "rb") as file:
    model = pickle.load(file)

# Test the loaded model
input_text = "Blue cotton t-shirt with logo"
result = model(input_text, top_n=3)
print(result)